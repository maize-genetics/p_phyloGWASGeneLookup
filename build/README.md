...
| Climate association results (stage 08) | `output/finalModels_20251002/envPC_{1,2,3}/ASREML_res_empPadded_homologAdded.txt` | Per-OG phylogenetic mixed-model test of gene presence/absence against each climate PC. `partialCoeff_PAV`'s sign gives the direction shown in the dashboard. |
